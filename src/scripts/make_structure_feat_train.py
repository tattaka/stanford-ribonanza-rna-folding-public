# ! conda install -y -c bioconda eternafold
...
train_data = pd.read_parquet(
    "../../input/stanford-ribonanza-rna-folding-converted/train_data.parquet"
)
...
while chunk_start < (len(train_data)):
    os.makedirs(
...
new_df.to_parquet(
    "../../input/stanford-ribonanza-rna-folding-converted/train_structure.parquet",
    index=False,
)
